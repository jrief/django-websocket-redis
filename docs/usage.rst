...
.. code-block:: python
	...
	redis_publisher = RedisPublisher(facility='foobar',
	                                 sessions=['wnqd0gbw5obpnj50zwh6yaq2yz4o8g9x']
	                                 broadcast=true)
	message = RedisMessage('Hello World')

	# and somewhere else
	receivers = redis_publisher.publish_message(message)
	print(receivers)
	# {
	#     'ws4redis:session:wnqd0gbw5obpnj50zwh6yaq2yz4o8g9x:foobar': 1,
	#     'ws4redis:broadcast:foobar': 1
	# }
